...
import { generatePosicionTitle, calculatePosicionTotalKilos, calculatePosicionTotalUnidades } from "../../../stock/utils/posicionUtils";
            ...
            {isExpanded ? (
              ...
              posicion.items.map((item, index) => (
                <div key={index} className={styles.item} onClick={handleItemClick}>
                  ...
                  {/* Botones para cada item - Adaptados para Salida */}
                  <Box sx={{ mt: 1, display: 'flex', gap: 1 }}>
                    ...
                    <Button
                      ...
                      sx={{ display: 'none' }} // Oculto en Salida
                    >
                      Eliminar
                    </Button>
                  </Box>
